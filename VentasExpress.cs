...
namespace ventasExpress
{
    public partial class VentasExpress : Form
    {
        ...
        private void VentasExpress_Load(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Sea Bienvenido " + usuarioActivo + "!","Sientase como en casa",MessageBoxButtons.OK,MessageBoxIcon.Information);

            label10.Text = System.Globalization.CultureInfo.CurrentCulture.TextInfo.ToTitleCase(label10.Text);
        ...
        private void VentasExpress_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
